...
def resetLevel(value) {
    ...
    log.debug "resetLevel >> value: $value, resulting level: $level"
    delayBetween ([delayBetween ([zwave.basicV1.basicSet(value: level).format(), zwave.basicV1.basicSet(value: 0x00).format()], 10), 
